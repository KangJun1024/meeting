...
public class StateJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        log.info("=========================================StateJob任务开始==========================================");
        //更新任务完成状态
        try {
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("booking_room_id",bookiongRoomId);
            jsonObject.put("state",type); // 已开始1  已结束2
            String result = bookingMeetingRoomService.startMeeting(jsonObject);
            JSONObject object = JSONObject.parseObject(result);
            if("success".equals(object.getString("Result"))){
                log.info("=========================================StateJob生成任务结束 id:[{}] ==========================================",bookiongRoomId);
            }
        }catch (Exception e){
            log.error("开始会议发生异常：", e);
        }
